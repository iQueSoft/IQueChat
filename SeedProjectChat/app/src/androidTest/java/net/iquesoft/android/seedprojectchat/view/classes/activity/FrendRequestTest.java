...
public class FrendRequestTest {
    ...
    public synchronized void frendRequestTest() throws Exception {
        ...
        ViewInteraction floatingActionButton2 = onView(
                allOf(ViewMatchers.withId(net.iquesoft.android.seedprojectchat.R.id.recycler_view_find_user), isDisplayed()));
        floatingActionButton2.perform(RecyclerViewActions.actionOnItemAtPosition(0, clickChildViewWithId(net.iquesoft.android.seedprojectchat.R.id.fab_send_friend_request)));
        ...
        ViewInteraction relativeLayout = onView(
                Matchers.allOf(ViewMatchers.withId(net.iquesoft.android.seedprojectchat.R.id.recycler_my_invite)));
        relativeLayout.check(matches(isDisplayed()));

        ViewInteraction floatingActionButton3 = onView(
                allOf(ViewMatchers.withId(net.iquesoft.android.seedprojectchat.R.id.recycler_my_invite), isDisplayed()));
        floatingActionButton3.perform(RecyclerViewActions.actionOnItemAtPosition(0, clickChildViewWithId(net.iquesoft.android.seedprojectchat.R.id.btn_revocation)));
        ...
        ViewInteraction apppCompatt = onView(
                allOf(ViewMatchers.withId(net.iquesoft.android.seedprojectchat.R.id.title), withText("Logout"), isDisplayed()));
