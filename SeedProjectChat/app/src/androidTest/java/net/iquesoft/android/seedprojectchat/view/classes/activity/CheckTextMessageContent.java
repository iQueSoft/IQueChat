...
import net.iquesoft.android.seedprojectchat.RecyclerViewMatcher;
...
public class CheckTextMessageContent {
    ...
    public synchronized void loginActivityTest2() throws InterruptedException {
        ...
        ViewInteraction appCompatButton4 = onView(
                allOf(ViewMatchers.withId(net.iquesoft.android.seedprojectchat.R.id.but_facebook), withText("Facebook Login")));
        ...
        ViewInteraction appCompatButton3 = onView(
                allOf(ViewMatchers.withId(net.iquesoft.android.seedprojectchat.R.id.but_twitter), withText("Twitter  login")));
        ...
        clickOnRecyclerView(net.iquesoft.android.seedprojectchat.R.id.main_screen_recycler_view, 0);

        ViewInteraction emojiconEditText = onView(
                allOf(ViewMatchers.withId(net.iquesoft.android.seedprojectchat.R.id.messageEdit), isDisplayed()));
        emojiconEditText.perform(replaceText("ESP"), closeSoftKeyboard());

        ViewInteraction appCompatButton2 = onView(
                allOf(ViewMatchers.withId(net.iquesoft.android.seedprojectchat.R.id.chatSendButton), withText("Send MSG"),
                        withParent(allOf(ViewMatchers.withId(net.iquesoft.android.seedprojectchat.R.id.linearLayout2),
                                withParent(ViewMatchers.withId(net.iquesoft.android.seedprojectchat.R.id.container)))),
                        isDisplayed()));
        appCompatButton2.perform(click());

        wait(3000);

        scrollRecyclerView(net.iquesoft.android.seedprojectchat.R.id.messagesContainer, 0);

        onView(withRecyclerView(net.iquesoft.android.seedprojectchat.R.id.messagesContainer).atPosition(0)).perform()
