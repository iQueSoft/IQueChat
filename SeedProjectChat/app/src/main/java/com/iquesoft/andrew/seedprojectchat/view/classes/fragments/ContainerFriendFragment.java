...
import com.iquesoft.andrew.seedprojectchat.view.interfaces.fragments.IContainerFriendFragment;
...
public class ContainerFriendFragment extends BaseFragment implements IContainerFriendFragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_container_friend, container, false);
