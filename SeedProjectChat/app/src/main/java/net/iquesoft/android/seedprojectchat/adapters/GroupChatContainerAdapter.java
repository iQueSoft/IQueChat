            ...
            if (curentGroupChat.getMessages().size() != 0){
                ...
                if (user != null){
                    if (user.getProperty(ChatUser.PHOTO) != null){
                        ...
                        Picasso.with(context).load(uri).placeholder(net.iquesoft.android.seedprojectchat.R.drawable.seed_logo).error(net.iquesoft.android.seedprojectchat.R.drawable.error).into(holder.cimUserImage);
                    }
                    Boolean online = (Boolean) user.getProperty(ChatUser.ONLINE);
                    if (online){
                        holder.cimOnline.setImageDrawable(context.getResources().getDrawable(net.iquesoft.android.seedprojectchat.R.drawable.online));
                    } else {
                        holder.cimOnline.setImageDrawable(context.getResources().getDrawable(net.iquesoft.android.seedprojectchat.R.drawable.offline));
                    }
                }
