...
public class MainFragmentAdapter extends RecyclerView.Adapter<MainFragmentAdapter.ViewHolder> {
    ...
    public MainFragmentAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(net.iquesoft.android.seedprojectchat.R.layout.fragment_group_chat_container_raw, parent, false);
    ...
    private void setUserPhoto(MainFragmentAdapter.ViewHolder holder){
        try {
            ...
            Picasso.with(mainActivity.getBaseContext()).load(uri).placeholder(net.iquesoft.android.seedprojectchat.R.drawable.placeholder).error(net.iquesoft.android.seedprojectchat.R.drawable.error).into(holder.cimUserImage);
        } catch (Throwable e) {
            e.printStackTrace();
        }
        ...
        try {
            if (user.getProperty(ChatUser.ONLINE).toString().equals("true")) {
                holder.cimOnline.setImageDrawable(mainActivity.getBaseContext().getResources().getDrawable(net.iquesoft.android.seedprojectchat.R.drawable.online));
            } else {
                holder.cimOnline.setImageDrawable(mainActivity.getBaseContext().getResources().getDrawable(net.iquesoft.android.seedprojectchat.R.drawable.offline));
            }
        } catch (Throwable e) {
            e.printStackTrace();
        }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            relativeLayout = (RelativeLayout) itemView.findViewById(net.iquesoft.android.seedprojectchat.R.id.rl_group_chat_container_raw);
            recyclerView = (RecyclerView) itemView.findViewById(net.iquesoft.android.seedprojectchat.R.id.relLayout);
            cimUserImage = (CircularImageView) itemView.findViewById(net.iquesoft.android.seedprojectchat.R.id.cim_user_image);
            cimOnline = (CircularImageView) itemView.findViewById(net.iquesoft.android.seedprojectchat.R.id.cim_online);
            tvChatName = (TextView) itemView.findViewById(net.iquesoft.android.seedprojectchat.R.id.tv_group_chat_name);
            tvLastMessage = (EmojiconTextView) itemView.findViewById(net.iquesoft.android.seedprojectchat.R.id.tv_last_message);
            tvLastMessageDate = (TextView) itemView.findViewById(net.iquesoft.android.seedprojectchat.R.id.tv_last_message_date);
        }
    }
